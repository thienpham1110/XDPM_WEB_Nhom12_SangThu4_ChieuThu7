            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                ...
                <div class="aa-myaccount-register">                 
                 <h4>Thông tin khách hàng</h4>
                    ...
                    <div class="form-group{{ $errors->has('dtngaysinh') ? ' has-error' : '' }}">
                        <label class="col-md-4 control-label">Ngày Sinh</label>

                        <div class="col-md-6">
                            <input type="text" class="form-control" name="dtngaysinh" value="{{ old('dtngaysinh') }}">

                            @if ($errors->has('dtngaysinh'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('dtngaysinh') }}</strong>
                                </span>
                            @endif
                        </div>
                    </div>
